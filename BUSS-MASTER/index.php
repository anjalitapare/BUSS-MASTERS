...
<head>
    ...
    <title>Buss Ticket Bookings</title>
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">BUSS MASTER</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Buss Master Ticket Booking System</h1>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                "Travel is the only thing you buy that makes you richer. Book your ticket today!"         </p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Buss Master Ticket Booking  | Made  &#10084;&#65039; By Anjali
                        </p>
        </footer>
    </div>
